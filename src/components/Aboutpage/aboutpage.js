    ...
    return(
        ...
        <header className='relative w-full normal:w-[1349px] h-fit min-h-[657px] flex flex-col pb-[100px]' style={{display: (showNavigation) ? 'none' : 'flex'}}>
            ...
            <div className='relative top-0 bottom-0 my-auto flex flex-col h-fit w-fit z-10 py-[100px] px-[60px] self-end'>
                <h1 className='text-white font-rufina font-bold text-xxxxxxxxl h-fit w-full minTablet:w-[400px]'>Who We Are</h1>
                <p className='text-white font-rufina font-bold text-xxl w-full minTablet:w-[500px]'>The most important thing for us is to give you the comfortable dining experience</p>
                <button className='w-full microPhone:w-[200px] px-[20px] h-fit min-h-[60px] border-2 border-white text-white font-rufina font-bold text-xxl mt-[20px] hover:bg-darkwhite'><a href='/portfolio'>Our Portfolio</a></button>
            </div>
        </header>
        <Navigation/>
        <main className='overflow-hidden w-full normal:w-[1349px] h-fit flex flex-col pt-[100px]' style={{display: (showNavigation) ? 'none' : 'flex'}}>
            <section className='relative flex flex-col minTablet:flex-row justify-between items-center w-full h-fit px-[60px] py-[100px]'>
                <img className='absolute top-[50px] phone:top-0 left-[50%] phone:left-[38%] w-[101px] phone:w-[150px] tablet:w-[200px] h-[85px] phone:h-[128px] tablet:h-[170px] object-cover' src={TomatoBlack} alt='illustration of a tomato' aria-hidden='true'/>
                <div className='w-full minTablet:w-[40%] h-fit flex flex-col'>
                    <h2 className='font-bold font-rufina text-xxxxxxxl'>Our Story</h2>
                ...
                <img className='w-full minTablet:w-[50%] h-[200px] smartPhone:h-[250px] phone:h-[300px] laptop:h-[400px] object-cover mt-[100px] minTablet:mt-0' src={ChefSeasoning} alt='image of a cuisine' aria-hidden='true'/>
            </section>
            ...
            <section className='relative w-full h-[500px] flex justify-center items-center'>
                ...
                <video ref={videoPlayer} className='object-cover w-full h-full' loop>
            ...
            <section className='relative w-full h-fit px-[60px] py-[150px]'>
                ...
                <h2 className='font-bold text-center font-rufina text-xxxxxl smartPhone:text-xxxxxxxl'>Sophisticated Process</h2>
                <div className='flex flex-col minTablet:flex-row items-center justify-between w-full h-fit mt-[150px] mb-[50px]'>
                    <img className='w-full minTablet:w-[50%] tablet:w-[45%] h-[250px] smartPhone:h-[300px] tablet:h-[400px] object-cover' src={ManSlicing} alt='image of a man slicing' aria-hidden='true'/>
                    <div className='flex flex-col w-full minTablet:w-[45%] h-full mt-[30px] minTablet:mt-0'>
                        <h3 className='font-bold font-rufina text-xxxxl smartPhone:text-xxxxxxl'>01.Slice</h3>
                        <p className='text-base font-normal text-left font-lato'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Purus lorem id penatibus imperdiet. Turpis egestas ultricies purus auctor tincidunt lacus nunc. Convallis pellentesque quis fringilla sagittis. Egestas in risus sit nunc nunc, arcu donec nam etiam. </p>
                    </div>
                </div>
                <div className='flex flex-col-reverse items-center justify-between w-full minTablet:flex-row h-fit'>
                    <div className='flex flex-col-reverse w-full minTablet:w-[400px] h-fit mt-0 minTablet:mt-[50px] mb-[50px] mx-[40px] tablet:mx-[70px]'>
                        <img className='w-full h-[178px] smartPhone:h-[228px] tablet:h-[328px] object-cover' src={GrilledMeat} alt='image of a man slicing' aria-hidden='true'/>
                        <div className='flex flex-col h-full mb-[30px]'>
                            <h3 className='font-bold font-rufina text-xxxxl smartPhone:text-xxxxxxl'>03.Bake</h3>
                            <p className='text-base font-normal text-left font-lato'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Purus lorem id penatibus imperdiet. </p>
                        </div>
                    </div>
                    <div className='flex flex-col items-center w-full minTablet:w-[45%] h-fit mb-[50px]'>
                        <img className='w-full minTablet:w-[400px] h-[178px] smartPhone:h-[228px] tablet:h-[328px] object-cover' src={SeasonedMeat} alt='image of a man slicing' aria-hidden='true'/>
                        <div className='flex flex-col h-full mt-[30px]'>
                            <h3 className='font-bold font-rufina text-xxxxl smartPhone:text-xxxxxxl'>02.Pickled</h3>
                            <p className='font-lato font-normal text-base text-left w-full minTablet:w-[230px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Purus lorem id penatibus imperdiet.</p>
                        </div>
                    </div>
                </div>
