        ...
        <>
            <div className='h-fit w-full laptop:w-[450px] flex flex-col items-center mt-[100px] laptop:mt-0'>
                <div className='relative h-fit w-full'> 
                    <img className='h-[450px] tablet:h-[900px] laptop:h-[450px] w-full object-cover' src={props.imageUrl} alt={props.imagedescription} aria-hidden='true'/> 
                ...
                <div className='mt-[40px] h-fit w-[90%] laptop:w-[400px]'>
                    <div className='flex flex-row justify-between items-center h-fit w-full phone:w-[320px] laptop:w-4/5 mb-[15px]'>
