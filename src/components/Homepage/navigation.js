...
export default function Navigation(){
    ...
    return(
        <>
            <section className='relative h-fit phone:h-screen w-full flex justify-center items-center bottom-0 z-30' style={{display : (showNavigation) ? 'flex' : 'none'}}>
                <img className='object-cover absolute w-full h-full top-0' src={navigationbg} alt='image of a flower' aria-hidden='true'/>
                <div className='absolute w-full h-full bg-darkgreen/80 top-0'></div>
                ...
                <div className='z-10 h-fit w-full phone:w-[1000px] flex flex-col phone:flex-row justify-between px-[100px] py-[100px]'>
                    ...
                    <div className='w-full phone:w-1/5 h-fit min-h-[180px] self-end flex flex-col justify-between'>
                        ...
                        <p className='font-lato text-white font-normal text-xxxsm w-full tablet:w-2/5'>+86 852 346 000 info@foodzero.com</p>
                        <p className='font-lato text-white font-normal text-xxxsm w-full tablet:w-3/5'>1959 Sepulveda Blvd. Culver City, CA, 90230</p>
