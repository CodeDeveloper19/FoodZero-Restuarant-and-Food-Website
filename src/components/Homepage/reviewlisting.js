    ...
    return(
        <>
            <div className='relative py-[100px] px-[120px] h-full w-screen'>
                ...
                <div className='mt-[50px] w-full h-fit flex flex-col tablet:flex-row'>
                    ...
                    <div className='w-fit tablet:w-2/4 h-[100px] flex flex-row items-center tablet:justify-end'>
                        <button 
                        onClick={() => {
                            settingPosition();
                        }}>
