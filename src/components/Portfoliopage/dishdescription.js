...
import HeaderImage from "../../images/Portfoliopage/portfolio_header.png";
...
import cuisine1 from '../../images/Portfoliopage/Dishname/cuisine1.png';
import cuisine2 from '../../images/Portfoliopage/Dishname/cuisine2.png';
import cuisine3 from '../../images/Portfoliopage/Dishname/cuisine3.png';
            ...
            <main className="relative overflow-hidden w-full normal:w-[1349px] h-fit flex flex-col items-center mt-[100px]" style={{display: (showNavigation) ? 'none' : 'flex'}}>
                <section className='relative flex flex-col w-full h-fit px-[150px] pb-[120px]'>
                    <div className="w-full h-fit flex flex-row justify-between items-start z-10">
                        ...
                        className='object-cover w-[350px] h-[500px]' src={cuisine1} alt='image of the portfolio dish 1' aria-hidden='true'/> 
                    ...
                    <div className="relative top-[-100px] flex flex-row self-end h-fit w-fit">
                        ...
                        className='object-cover w-[500px] h-[600px]' src={cuisine2} alt='image of the portfolio dish 2' aria-hidden='true'/>
                    ...
                    <div className="flex flex-col items-center w-full h-fit">
                        ...
                        className='object-cover w-full h-[550px] my-[100px]' src={cuisine3} alt='image of the portfolio dish 3' aria-hidden='true'/>
                    </div>
                </section>
