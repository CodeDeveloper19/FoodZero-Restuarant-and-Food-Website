    ...
    return(
        <>
            ...
            <main className="relative overflow-hidden w-full normal:w-[1349px] h-fit flex flex-col items-center mt-[100px]" style={{display: (showNavigation) ? 'none' : 'flex'}}>
                ...
                <section className='flex flex-row items-end justify-between items-center w-full h-fit px-[60px] py-[120px] bg-lightwhite text-center'>
                    <div className="flex flex-col h-fit min-h-full max-w-[40%]">
                        <div className="flex flex-row h-fit items-center justify-center">
                            <button className="z-10 w-[40px] h-[40px] self-start microPhone:self-end mt-[10px] microPhone:mt-0" onClick={() => {
                                setDishChanged(true);
                            }}>
                        ...
                        <p className="font-rufina font-bold text-xxxxl mt-[20px]">{changeDish[1]}</p>
                    </div>
                    ...
                    <div className="flex flex-col h-fit min-h-full max-w-[40%]">
                        ...
                        <p className="font-rufina font-bold text-xxxxl mt-[20px]">{changeDish[0]}</p>
                    </div>
                </section>
            </main>
            <Footer />
